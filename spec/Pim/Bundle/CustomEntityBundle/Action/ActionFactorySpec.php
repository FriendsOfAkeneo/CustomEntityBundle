...
class ActionFactorySpec extends ObjectBehavior
{
    ...
    public function it_returns_actions(
        ...
        $configuration2->hasAction('action2')->willReturn(false);

        $container->get('action1')->shouldBeCalledTimes(1)->willReturn($action1);
        $container->get('action2')->shouldBeCalledTimes(1)->willReturn($action2);
        ...
        $this->getAction('entity2', 'action2')->shouldReturn(null);
