...
namespace spec\Pim\Bundle\CustomEntityBundle\EventListener;
...
class ConfigureCustomEntityGridListenerSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Pim\Bundle\CustomEntityBundle\EventListener\ConfigureCustomEntityGridListener');
    }
